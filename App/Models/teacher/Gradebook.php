...
$stmt = $pdo->prepare("SELECT s.id, u.first_name, u.last_name, st.student_id
                      FROM students s
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'update_grade') {
    ...
    try {
        ...
        $msg = "<div class='alert alert-success'>Grade updated successfully!</div>";
        ...
        $msg = "<div class='alert alert-danger'>Error updating grade: " . htmlspecialchars($e->getMessage()) . "</div>";
    }
}
?>
