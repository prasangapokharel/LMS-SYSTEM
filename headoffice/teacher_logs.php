...
<body class="bg-gray-50 min-h-screen">
            ...
            <main class="p-4 lg:p-6">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?= $stats['total_logs'] ?></p>
                    ...
                    <div class="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?= $stats['logs_this_month'] ?></p>
                            <p class="text-xs text-gray-500">Monthly Logs</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?= $stats['active_teachers'] ?></p>
                    ...
                    <div class="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?= $stats['avg_logs_per_teacher'] ?></p>
                            <p class="text-xs text-gray-500">Avg per Teacher</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 mb-6">
                    <div class="p-4 border-b border-gray-100">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <h2 class="text-lg font-semibold text-gray-900 flex items-center mb-3 sm:mb-0">
                    ...
                    <div class="p-4">
                        <form method="get" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                            <div>
                                ...
                                <select name="teacher_id" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <select name="class_id" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <select name="subject_id" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="xl:col-span-6 flex items-center space-x-2 mt-2">
                                ...
                                <a href="teacher_logs.php" class="px-4 py-2 bg-gray-100 text-gray-700 text-sm rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors">
                                    Clear
                                </a>
                            </div>
                        </form>
                    ...
                    <div class="px-4 py-3 border-t border-gray-200">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-1">
                                ...
                                class="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                                    Previous
                                </a>
                                <?php endif; ?>
                                ...
                                class="px-3 py-1 text-xs <?= $i == $page ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?> rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                                    <?= $i ?>
                                </a>
                                <?php endfor; ?>
                            ...
                            <?php if (!empty($teaching_methods)): ?>
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-xs text-gray-600"><?= $method['count'] ?></span>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                            ...
                            <?php if (!empty($monthly_trends)): ?>
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-xs text-gray-600"><?= $trend['count'] ?> logs</span>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            <?php else: ?>
    ...
    <!-- Log Details Modal -->
    <div id="logModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50 flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto m-4">
            <div class="p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-900">Teacher Log Details</h3>
            ...
            <div class="p-4 border-t border-gray-200 bg-gray-50 flex justify-end">
                <button onclick="closeModal()" class="px-4 py-2 bg-gray-100 text-gray-700 text-sm rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors">
                    Close
                </button>
            </div>
        </div>
            ...
            content.innerHTML = `
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="space-y-3">
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Date</label>
                                <p class="text-sm text-gray-900">${new Date(log.log_date).toLocaleDateString()}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Teacher</label>
                                <p class="text-sm text-gray-900">${log.first_name} ${log.last_name}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Class</label>
                                <p class="text-sm text-gray-900">${log.class_name} ${log.section}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Subject</label>
                                <p class="text-sm text-gray-900">${log.subject_name}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Teaching Method</label>
                                <p class="text-sm text-gray-900">${log.teaching_method || 'N/A'}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Duration</label>
                                <p class="text-sm text-gray-900">${log.lesson_duration ? log.lesson_duration + ' minutes' : 'N/A'}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Students Present</label>
                                <p class="text-sm text-gray-900">${log.students_present || 'N/A'}</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h4 class="font-semibold text-gray-900 mb-3">Content Details</h4>
                        <div class="space-y-3">
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Chapter Title</label>
                                <p class="text-sm text-gray-900">${log.chapter_title}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Chapter Content</label>
                                <p class="text-sm text-gray-900">${log.chapter_content || 'N/A'}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Topics Covered</label>
                                <p class="text-sm text-gray-900">${log.topics_covered || 'N/A'}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Homework Assigned</label>
                                <p class="text-sm text-gray-900">${log.homework_assigned || 'N/A'}</p>
                            </div>
                            <div>
                                <label class="text-xs font-medium text-gray-500 block">Additional Notes</label>
                                <p class="text-sm text-gray-900">${log.notes || 'N/A'}</p>
                            </div>
                        </div>
                    </div>
                </div>
