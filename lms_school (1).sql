...
(27, 'WAP to create PYTHON variable.', 'Simple and clean program', 1, 4, 11, '2025-06-21', NULL, NULL, NULL, '2025-06-22', NULL, NULL, NULL, 1, 'homework', 'Open vs code crewte new file and', NULL, 1, '2025-06-21 06:51:48', '2025-06-21 06:51:48');
...
(8, 27, 1, '2025-06-21 06:52:43', 'done', 'uploads/assignments/1_27_1750488763.jpeg', 'submitted', NULL, NULL, NULL, NULL, 0);
...
INSERT INTO `notices` (`id`, `title`, `content`, `notice_image`, `created_by`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'Notice', 'Holiday', 'uploads/notices/notice_1750486405_1316.jpeg', 11, 1, '2025-06-21 06:13:25', '2025-06-21 06:13:25'),
(2, 'Field Visite to chitwan - BSW', 'Tommorow ', 'uploads/notices/notice_1750489545_8553.jpeg', 11, 1, '2025-06-21 07:05:45', '2025-06-21 07:05:45');
...
(7, 'Mathematics', 'MATH', NULL, NULL, 'Mathematics and Numerical Skills', 1, '2025-06-21 07:30:55'),
(8, 'English', 'ENG', NULL, NULL, 'English Language and Literature', 1, '2025-06-21 07:30:55'),
(9, 'Science', 'SCI', NULL, NULL, 'General Science', 1, '2025-06-21 07:30:55'),
(10, 'Physics', 'PHY', NULL, NULL, 'Physics', 1, '2025-06-21 07:30:55'),
(11, 'Chemistry', 'CHEM', NULL, NULL, 'Chemistry', 1, '2025-06-21 07:30:55'),
(12, 'Biology', 'BIO', NULL, NULL, 'Biology', 1, '2025-06-21 07:30:55'),
(13, 'History', 'HIST', NULL, NULL, 'History and Social Studies', 1, '2025-06-21 07:30:55'),
(14, 'Geography', 'GEO', NULL, NULL, 'Geography', 1, '2025-06-21 07:30:55'),
(15, 'Computer Science', 'CS', NULL, NULL, 'Computer Science and Programming', 1, '2025-06-21 07:30:55'),
(16, 'Physical Education', 'PE', NULL, NULL, 'Physical Education and Sports', 1, '2025-06-21 07:30:55'),
(17, 'Art', 'ART', NULL, NULL, 'Art and Craft', 1, '2025-06-21 07:30:55'),
(18, 'Music', 'MUS', NULL, NULL, 'Music and Performing Arts', 1, '2025-06-21 07:30:55');
...
(83, 5, 'user_login', NULL, NULL, NULL, NULL, '192.168.1.72', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1', '2025-06-21 06:00:33'),
(84, 11, 'user_login', NULL, NULL, NULL, NULL, '192.168.1.72', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1', '2025-06-21 06:12:15'),
(85, 5, 'user_login', NULL, NULL, NULL, NULL, '192.168.1.85', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Mobile Safari/537.36', '2025-06-21 06:29:52'),
(86, 11, 'attendance_recorded', 'attendance', NULL, NULL, '{\"class_id\":1,\"date\":\"2025-06-21\"}', '192.168.1.72', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1', '2025-06-21 06:49:22'),
(87, 11, 'attendance_recorded', 'attendance', NULL, NULL, '{\"class_id\":1,\"date\":\"2025-06-21\"}', '192.168.1.72', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1', '2025-06-21 06:50:06'),
(88, 11, 'assignment_created', 'assignments', 27, NULL, NULL, '192.168.1.72', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1', '2025-06-21 06:51:48'),
(89, 5, 'assignment_submitted', 'assignment_submissions', 8, NULL, NULL, '192.168.1.72', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1', '2025-06-21 06:52:43'),
...
INSERT INTO `teacher_classes` (`id`, `teacher_id`, `class_id`, `subject_id`, `academic_year_id`, `assigned_date`, `is_active`, `created_at`) VALUES
(1, 1, 1, 15, 1, '2025-06-21', 1, '2025-06-21 07:33:57'),
(2, 1, 1, 6, 1, '2025-06-21', 1, '2025-06-21 07:33:57'),
(3, 1, 2, 4, 1, '2025-06-21', 1, '2025-06-21 07:33:57');
...
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject_id`, `assigned_date`, `is_active`, `created_at`) VALUES
(1, 1, 15, '2025-06-21', 1, '2025-06-21 07:33:57');
...
INSERT INTO `users` (`id`, `username`, `email`, `password_hash`, `password_reset_required`, `first_name`, `last_name`, `phone`, `address`, `profile_image`, `role_id`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'principal', 'principal@school.com', '$2y$10$6qipZ0oam5xnLmKVb8nKt.QHP3.W3z2fzWVyy9OEAzWafBwdmrUWm', 0, 'John', 'Smith', '9841234567', NULL, NULL, 1, 0, '2025-06-02 02:52:54', '2025-06-13 16:53:56'),
(2, 'teacher001', 'math.teacher@school.com', '$2y$10$xJdjQp4tX.in3EZwYSczlOt00gYxJlheY1YSA5833rZL2OaNwhuhC', 0, 'Sarah', 'Johnson', '9841234568', NULL, NULL, 2, 1, '2025-06-02 02:52:54', '2025-06-13 10:29:01'),
(3, 'teacher002', 'english.teacher@school.com', '$2y$10$8K1p/a96pBKFaEgbuS4WOdSrvAiC7kwxVjsAHlyRc8em/fxIgHZ5W', 0, 'Michael', 'Brown', '9841234569', NULL, NULL, 2, 1, '2025-06-02 02:52:54', '2025-06-02 02:52:54'),
(4, 'teacher003', 'science.teacher@school.com', '$2y$10$8K1p/a96pBKFaEgbuS4WOdSrvAiC7kwxVjsAHlyRc8em/fxIgHZ5W', 0, 'Emily', 'Davis', '9841234570', NULL, NULL, 2, 1, '2025-06-02 02:52:54', '2025-06-02 02:52:54'),
(5, 'student001', 'student001@school.com', '$2y$10$VvRXHy3uFncYOR2v8/FoaOzcUgV3u80hbZ0EtOOHTTD6SHxu389My', 0, 'Alice', 'Wilson', '9841234571', NULL, NULL, 3, 1, '2025-06-02 02:52:54', '2025-06-20 06:24:46'),
(6, 'student002', 'student002@school.com', '$2y$10$TKh8H1.PfQx37YgCzwiKb.KjNyWgaHb9cbcoQgdIVFlYg7B77UdFm', 0, 'Bob', 'Anderson', '9841234572', NULL, NULL, 3, 1, '2025-06-02 02:52:54', '2025-06-02 02:52:54'),
...
(14, 'principal_jane', 'jane.principal@school.com', '$2y$10$9a0b1c2d3e4f5g6h7i8j9k0l1m2n3o4p5q6r7s8t9u0v1w2x3y4z5a6', 0, 'Jane', 'Doe', '9841234581', '456 Elm St, City', NULL, 1, 1, '2025-06-13 16:49:31', '2025-06-13 16:49:31'),
(17, 'principal_mark', 'mark.principal@school.com', '$2y$10$1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6p7q8r9s0t1u2v3w4x5y6z7a', 0, 'Dharma', 'Neupane', '9841234582', '789 Oak St, City', NULL, 1, 1, '2025-06-13 16:50:36', '2025-06-19 16:04:02'),
...
ALTER TABLE `teacher_classes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_teacher_class_subject` (`teacher_id`,`class_id`,`subject_id`,`academic_year_id`),
...
--
ALTER TABLE `teacher_classes`
  ADD CONSTRAINT `teacher_classes_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_profiles` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `teacher_subjects`
  ADD CONSTRAINT `teacher_subjects_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_profiles` (`id`) ON DELETE CASCADE,
